...
<h3>&cosme</h3>
    ...
    <form action="k_seles.php">
        <div id="center"><button type="submit" class="ao">売上管理</button></p></div>
    </form>

    <form action="k_cosme_new.php" method="post">
        <div id="center"><button type="submit" class="ao">商品登録</button></p></div>
    </form>

    <form action="k_member_new.php" method="post">
        <div id="center"><button type="submit" class="ao">管理者登録</button></p></div>
    </form>

    <form action="k_logout.php">
        <div id="center"><button type="submit" class="grey">ログアウト</button></p></div>
    </form>
