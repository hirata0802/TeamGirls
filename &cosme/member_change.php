...
<h3>&cosme</h3>
    ...
    foreach($sql as $row){
       ...
       echo '<input type="text" style="width: 253px;height: 27px;" name="zipcode" id="zipcode" value="',$row['post_code'],'" requiredy>';
       echo '</div>';
      ...
      echo '<div id="mannaka">';
       echo '<p><input type="tel" style="width: 253px;height: 27px;" name="tel" maxlength="11" pattern="^[0-9]+$" value="',$row['phone'],'" required>';
       echo '<br>';
       echo '<p><input type="email" style="width: 253px;height: 27px;" name="mail" value="',$row['email'],'" required>';
       echo '<br>';
       echo '<p><input type="password" style="width: 253px;height: 27px;" name="pass" value="',$_SESSION['customer']['pass'],'" required>';
       echo '</div>';
