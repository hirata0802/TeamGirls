    ...
    <form action="seach_output.php" method="post">
        ...
        echo '<table width="100%">';
            ...
            foreach($sql as $row){
                ...
                if($count%3!=0){
                    echo '<td align="center"><input type="image" src="',$row['brand_image_path'],'" alt="',$brand_id,'" style="object-fit: contain; width="100px" height="100px" formaction="seach_output.php?kubun=2&id=',$brand_id,'"><br>',$row['brand_name'],'</td>';
                }else{
                    echo '<td align="center"><input type="image" src="',$row['brand_image_path'],'" alt="',$brand_id,'" style="object-fit: contain; width="100px" height="100px" formaction="seach_output.php?kubun=2&id=',$brand_id,'"><br>',$row['brand_name'],'</td>';
                    echo '</tr><tr>';
                }
