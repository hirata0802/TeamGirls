...
<div id="center"><h2>登録確認</h2></div>
    ...
    <br>
    <button onclick="history.back()" class="next" style="width: 300px;height: 30px;">変更</button></p><br>
    <button type="submit" form="next" class="return" style="width: 300px;height: 30px;">新規登録</button></p>
</body>
</html>
